...
register_setting('tng-api-options', 'tng-api-event');
		...
		add_settings_field('tng-event', 'TNG Event to Track', function () {
            $tngEvent = esc_attr(get_option('tng-api-event'));
/*----------------------------------------------------------------------------------------*/           
		//$specialevent = $event->getEventList();
			foreach ($specialevent as $event):
				//var_dump($specialevent);
				echo "<option value=$$event>$row[display]</option>";
				endforeach;
		
		echo "<select name=event value=''>Event Name</option>"; // list box select command
...
/*----------------------------------------------------------------------------------------*/           
		   ...
		   echo "<input type='text' name='tng-api-event' value='$tngEvent' />";
        }, 'tng-api', 'general');
...
/* Get Special events for selection*/
