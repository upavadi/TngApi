...
/************** Tabs Shortcodes ******************
Version: 1.0.2 
Modified from original plugin, Tab-Me by Micah Blu
http://www.micahblu.com/
**************************************************/
...
function tab_me_scripts(){
	wp_enqueue_style('tab-me-styles', plugins_url( 'css/tab-me.css',__FILE__) );
        wp_enqueue_style('upavadi-styles', plugins_url( 'css/upavadi.css',__FILE__) );
	wp_enqueue_script('tab-me-js', plugins_url( 'js/tab-me.js', __FILE__), array('jquery'), null, true );
}
