...
$spousehusband = $spouseID;
	...
	<span style="color:#D77600; font-size:10pt"></br><?php echo "Add Details for Spouse for ". $person_name." ".$person_surname;?> below and then press NEXT to add Children. If there are no children, go ahead and press NEXT to enter Notes about the spouse.Do not Change or Refresh the page until you have submitted the changes by clicking on SAVE below.</p>
