...
?>
		...
		<td><input type="text" name="child[<?php echo $order; ?>][<?php echo $index; ?>][childdateborn]" value="<?php echo $childbirthdate;?>" size="08"/></td>
		<td><input type="text" name="child[<?php echo $order; ?>][<?php echo $index; ?>][childplaceborn]" value="<?php echo $childbirthplace;?>" size="10"/></td>
		<td><input type="text" name="child[<?php echo $order; ?>][<?php echo $index; ?>][childdatedied]" value="<?php echo $childdeathdate;?>" size="08"/></td>
...
initChildren(<?php echo $order; ?>);
		...
		<td><input type="text" name="child[<?php echo $order; ?>][<?php echo $index; ?>][childdateborn]" value="" size="08"/></td>
		<td><input type="text" name="child[<?php echo $order; ?>][<?php echo $index; ?>][childplaceborn]" value="" size="10"/></td>
		<td><input type="text" name="child[<?php echo $order; ?>][<?php echo $index; ?>][childdatedied]" value="" size="08"/></td>
