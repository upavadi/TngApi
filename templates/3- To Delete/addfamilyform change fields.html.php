...
$spousehusband = $spouseID;
	...
	<input type="hidden" name="order" value="<?php echo $spouseorder; ?>" />
		...
		<br/><br/><span style="color:#777777">(dd mmm yyyy)<br/></span><input type="text" name="spousedeathdate" value="" size="10"/>
			...
			<td valign="middle" class="tdfront"><input type="text" name="spousecause" value=""><br/><br/><input type="text" name="spousedeathplace" value="" /></td>
		</tr>
		
		<tr>
		<td class="tdback"><?php echo "Married" ?></td>
			<td valign="middle" class="tdfront"><span style="color:#777777">(dd mmm yyyy)<br/></span><input type="text" name="spousemarrdate" value="" /></td>
			<td class="tdback"><?php echo "Place"; ?></td>
			<td valign="middle" class="tdfront"><input type="text" name="spousemarrplace" value="" /></td>
		</tr>
	...
	<tbody>
		...
		<td><input type="text" name="child[0][childbirthdate]" value="" size="08"/></td>
		<td><input type="text" name="child[0][childbirthplace]" value="" size="10"/></td>
		<td><input type="text" name="child[0][childdeathdate]" value="" size="08"/></td>
		<td><input type="text" name="child[0][childdeathplace]" value="" size="10"/></td>
